...
//
//     /* test db array */
//     // const textNotifsCollection = firebase.firestore().collection('textNotifs');
//     // console.log(`textNotifsCollection: ${textNotifsCollection}`);
//
// // // Function to fetch documents and create the array
// //     async function getTextNotifsArray() {
// //         try {
// //             const snapshot = await textNotifsCollection.get();
// //
// //             const textNotifsArray = [];
// //             snapshot.forEach((doc) => {
// //                 const data = doc.data();
// //                 const { dailyNotif, phoneNumber } = data;
// //                 textNotifsArray.push({ [dailyNotif]: phoneNumber });
// //             });
// //
// //             return textNotifsArray;
// //         } catch (error) {
// //             console.error('Error fetching textNotifs:', error);
// //             return [];
// //         }
// //     }
// //
// // // Usage
// //     getTextNotifsArray().then((array) => {
// //         console.log(`getTextNotifsArray from DB: ${array}`); // Array of key-value pairs (dailyNotif: phoneNumber)
// //     });
//
